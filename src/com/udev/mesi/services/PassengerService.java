...
public class PassengerService {
    ...
    public static WsGetPassengers read(final String acceptLanguage, final String username, final String token) throws JSONException {
    ...
    public static WsExists emailExists(final String email, final String acceptLanguage, final String username, final String token) throws JSONException {
    ...
    public static WsExists phoneNumberExists(final String phoneNumber, final String acceptLanguage, final String username, final String token) throws JSONException {
    ...
    public static WsExists IDNumberExists(final String IDNumber, final String acceptLanguage, final String username, final String token) throws JSONException {
    ...
    public static WsGetSinglePassenger readOne(final long id, final String acceptLanguage, final String username, final String token) throws JSONException {
    ...
    public static WsGetReservations readReservations(final long id, final String acceptLanguage, final String username, final String token) throws JSONException {
