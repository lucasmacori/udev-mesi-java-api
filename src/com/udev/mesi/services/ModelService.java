...
public class ModelService {
    ...
    public static WsGetModels read(final String acceptLanguage, final String username, final String token) throws JSONException {
    ...
    public static WsGetSingleModel readOne(final long id, final String acceptLanguage, final String username, final String token) throws JSONException {
    ...
    public static WsGetPlanes readPlanes(final long id, final String acceptLanguage, final String username, final String token) throws JSONException {
